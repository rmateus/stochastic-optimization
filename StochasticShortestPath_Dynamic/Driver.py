...
if __name__ == "__main__":
    ...
    print(
        "Created network in {} tries. From origin {} to destination {}. Number of steps is {} and the average cost is {:.2f}. The deadline to define lateness will be {:.2f}".format(
            nTries,
            G.start_node,
            G.end_node,
            G.steps,
            G.get_avg_cost_paths(),
            G.get_deadline(),
        )
    )
    ...
    for theta in theta_list:
        ...
        print(
            "Avg total cost with parameter {0} is {1:.3f}. Probability of being late is {2:.2f} and avg number of steps is {3:.2f}\n ".format(
                theta, cost, penalty, steps
            )
        )
    ...
    fig1.suptitle(
        "Comparison of theta^cost -  origin {}, destination {}, dist {} - deadline {} and number of iterations {}".format(
            M.G.start_node,
            M.G.end_node,
            M.G.steps,
            G.get_deadline(),
